...
public class PatientService {
    ...
    public void createdPatientRecord(PatientRecordDTO patientRecordDTO, RedirectAttributes model) {
        ...
        if (!userService.checkPatientExist(username)) {
...
//    private PatientRecordDTOList getPatientRecordDTOList(List<Patient> patients) {
...
//    }
    ...
    private List<PatientRecordDTO> getPatientRecordDTOs(List<PatientRecord> patientRecords) {
...
//            PatientRecordDTOList patientRecordDTOList = this.getPatientRecordDTOList(department.getPatients());
...
//    }
    ...
    public PatientRecordDTOList showPatientRecordByDoctor(Model model) {
        ...
        if (!ObjectUtils.isEmpty(employee)) {
            List<PatientRecordDTO> patientRecordDTOs = this.getPatientRecordDTOs(doctorAuth.getEmployee().getPatientRecords());
    ...
    public void showRecordOfPatient(Patient patient, Model model) {
        PatientRecord patientRecord = patient.getPatientRecords().get(0);
