package UET.security.rbac.policy.json;

import UET.security.rbac.policy.PolicyDefinition;
import UET.security.rbac.policy.PolicyRule;
...
public class JsonFilePolicyDefinition implements PolicyDefinition {
	...
	private void init(){
		...
		try {
			...
			System.out.printf(rules.toString());
