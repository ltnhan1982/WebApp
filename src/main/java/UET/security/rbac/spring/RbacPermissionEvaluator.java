package UET.security.rbac.spring;

import UET.model.User;
import UET.repository.UserRepository;
import UET.security.rbac.policy.PolicyEnforcement;
...
public class RbacPermissionEvaluator implements PermissionEvaluator {
	private static Logger logger = LoggerFactory.getLogger(RbacPermissionEvaluator.class);
